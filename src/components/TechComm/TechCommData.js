...
export default function TechCommData({techCommProposal}) {
    const { proposal_id, created_block, reward , status, proposer , beneficiary} = techCommProposal
